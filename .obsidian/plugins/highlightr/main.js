...
class HighlightrSettingTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        new obsidian.Setting(containerEl)
            ...
            .then(() => {
            const higlighterHexArray = this.plugin.settings.highlighters.map((highlight) => {
            ...
            let pickr = new Pickr({
                ...
                default: this.plugin.settings.highlighters[this.plugin.settings.highlighters.length - 1].value,
                comparison: false,
                components: {
                    preview: true,
                    opacity: true,
            ...
            pickr
                ...
                document
                    ...
                    .setAttribute("style", `background-color: ${newColor}; color: var(--text-normal);`);
            })
                ...
                new obsidian.Notice("Highlight color saved");
                instance.hide();
            ...
            button
                ...
                const color = document.querySelector(".highlighter-settings-color"
                //@ts-ignore
                ).value;
                let value = document.querySelector(".highlighter-settings-value"
                //@ts-ignore
                ).value;
                if (color && value) {
                    ...
                    new obsidian.Notice("Highlighter color wasn't saved");
                }
                else if (!color && value) {
                    new obsidian.Notice("Highlighter name is missing");
                }
                else {
                    new obsidian.Notice("Missing highlighter values");
                }
            }));
        });
        ...
        this.plugin.settings.highlighters.forEach((highlighter) => {
            ...
            new obsidian.Setting(settingItem)
                ...
                button
                    ...
                    .setTooltip("Remove")
                    .onClick(() => __awaiter(this, void 0, void 0, function* () {
                    new obsidian.Notice(`${highlighter.color} highlight deleted`);
                    this.app.commands.removeCommand(`highlightr-plugin:${highlighter.color}`);
...
function highlighterMenu(app, plugin, settings) {
...
class HighlightrPlugin extends obsidian.Plugin {
    constructor() {
        ...
        this.handleHighlighterMenu = (menu, editor) => {
    ...
    generateCommands(editor) {
        this.settings.highlighters.forEach((highlighter) => {
