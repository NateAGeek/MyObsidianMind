...
[[Polynomial Regression]] is a type of [[Linear Regression]] that estimates relation of features by the nth degree. This allows the data to be better fir in regression, compared to pure [[Linear Regression]] 